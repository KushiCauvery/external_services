...
from custom_suds.constants import *
from custom_suds.umx import *
from custom_suds.umx.core import Core
from custom_suds.resolver import NodeResolver, Frame
...
class Typed(Core):
    ...
    def start(self, content):
        ...
        if content.type is None:
            ...
            if found is None:
                if content.node.name in KEYS_WITHOUT_DEFINITION:
                    found = self.resolver.find(content.node.parent.children[0])
